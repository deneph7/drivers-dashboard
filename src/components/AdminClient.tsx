          ...
          <div className="px-4 py-4 bg-blue-50 border-b border-blue-100 space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              <input
                ...
                className="col-span-2 rounded-lg border border-gray-300 px-3 py-2 text-base sm:text-sm text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-1 focus:ring-blue-500"
              />
              <input
                type="password"
              ...
              <input
                ...
                className="rounded-lg border border-gray-300 px-3 py-2 text-base sm:text-sm text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-1 focus:ring-blue-500"
              />
              <input
                type="text"
                ...
                <div className="space-y-2">
                  <div className="grid grid-cols-2 gap-2">
                    <input
                      ...
                      className="rounded-lg border border-gray-300 px-2 py-1.5 text-base sm:text-sm text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-1 focus:ring-blue-500"
                    />
                    <input
                      type="text"
                      placeholder="Initial"
