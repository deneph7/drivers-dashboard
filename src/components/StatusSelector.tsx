      ...
      {status === 'unavailable' && (
        <div className="space-y-1">
          ...
          <input
            ...
            className="w-full rounded-lg border border-gray-300 px-3 py-2 text-base sm:text-sm text-gray-900 placeholder:text-gray-400 focus:border-red-500 focus:outline-none focus:ring-1 focus:ring-red-500"
          />
        </div>
      )}
